...
def main():
    ...
    datasets = dataset_names[4:]            # starting with sst2
    ...
    output_file = f'llm_experiments_data/llm_experimental_results_mini_neurips_{date}.csv'
            ...
            for seed in range(num_seeds):
                ...
                for method in ["convex_comb", "pure_logits"]:
                    ...
                    for ens_method, indices in ensemble_methods.items():
                        ...
                        base = f"{safe_dataset}_{seed}_{method}_{ens_method}_{date}"
